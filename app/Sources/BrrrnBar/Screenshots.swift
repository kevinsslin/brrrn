    ...
    private static func fixtureReport(daily: [BurnReport.DailyEntry]) -> BurnReport {
        ...
        return BurnReport(
            ...
            byModel: [
                ...
                .init(source: "codex", model: "gpt-5.6-sol", speed: "medium priority",
                      inputTokens: 1_411_202, outputTokens: 388_113, reasoningTokens: 188_450,
                      totalTokens: 1_799_315, costUSD: 41.20),
